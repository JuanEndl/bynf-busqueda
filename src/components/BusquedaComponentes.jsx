        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96 border-2 border-solid">
            ...
            <div className="flex justify-end mt-6 space-x-3">
              <button className="text-white bg-green-700 hover:bg-green-800 rounded-lg px-5 py-2.5" disabled={seleccionados.length === 0} onClick={eliminarProductosSeleccionados}>Aceptar</button>
